...
##            self.setCentralWidget(textEdit)
            ...
            ####TEMP
            tempThetaAction = QtGui.QAction("temp Theta", self)
            tempThetaAction.triggered.connect(self.tempTheta)
            ####
            ...
            toolbar.addAction(tempThetaAction)
...
### TEMP
      ...
      def tempTheta(self):
            self.theta=arange(self.projections)*3
...
#================
      ...
      def convert2array(self):
            ...
            try:
                  f1=f[self.ImageTag]["images"]
                  self.channels,self.y,self.x=f1.shape
            except KeyError:
                  f1=f[self.ImageTag]["data"]
                  self.channels,self.y,self.x=f1.shape
